export const ecosystemContent = {
  meta: {
    title: "Ecosystem",
    description:
      "Explore the SecureTheCloud Sovereign Agent Control Plane: runtime governance, policy enforcement, evidence capture, trust verification, risk intelligence, and federation readiness for autonomous AI-agent systems.",
  },
  hero: {
    eyebrow: "SOVEREIGN AGENT CONTROL PLANE",
    headline: "One Control Plane for Governed Autonomous Systems",
    subheadline:
  ...
  visual: {
    ...
    title: "Governance, enforcement, evidence, and intelligence remain separated by design.",
    body:
  ...
  doctrine: {
    title: "The Doctrine: Evidence Proves. Policy Decides. Runtime Enforces.",
    body:
  ...
  layers: {
    title: "The SecureTheCloud Control-Plane Layers",
    body:
  ...
  platforms: {
    title: "Platforms Inside the Ecosystem",
    body:
    ...
    items: [
      {
        title: "Aegis Runtime",
        role: "Runtime authority and governance",
        body:
      ...
      },
      {
        ...
        role: "Kubernetes governance and enforcement",
        body:
      ...
      },
      {
        ...
        role: "Sovereign trust verification",
        body:
      ...
      },
      {
        ...
        role: "Evidence, replay, and audit proof",
        body:
      ...
      {
        title: "RiskDNA",
        role: "Risk scoring and blast-radius intelligence",
        body:
      ...
      },
      {
        ...
        role: "Claim-to-evidence truth verification",
        body:
      ...
      },
      {
        ...
        role: "Ecosystem Evidence & Readiness Navigator",
        body:
      ...
      {
        title: "SAFP",
        role: "Sovereign agent federation readiness",
        body:
  ...
  lifecycle: {
    title: "The Governed Agent Lifecycle",
    body:
  ...
  boundaries: {
    title: "Authority Boundaries Stay Explicit",
    body:
  ...
  intelligence: {
    title: "Offline Intelligence Without Runtime Authority Drift",
    body:
  ...
  cta: {
    headline: "Review the Sovereign Agent Control Plane.",
    subheadline:
