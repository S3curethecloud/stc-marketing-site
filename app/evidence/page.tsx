...
const publicEngineering = [
  ...
  },
  {
    ...
    serviceHref: "/services#ai-security-architecture",
    insightHref: "/insights/designing-secure-agent-architectures-for-the-enterprise-era",
    focus: "ai-security",
  },
  {
  ...
  },
  {
    ...
    serviceHref: "/services#governance-compliance",
    insightHref: "/insights/building-ai-governance-that-scales-with-enterprise-ambition",
    focus: "governance",
  },
  {
    ...
    <>
      ...
      <section className="border-b border-white/10 bg-[#050816]">
        <Container className="py-14 sm:py-16 lg:py-20">
          ...
          <div className="mt-10 grid gap-8 border-y border-white/10 py-8 md:grid-cols-2 lg:grid-cols-4">{proofModel.map((item) => <article key={item.title}><h3 className="text-lg font-semibold text-white">{item.title}</h3><p className="mt-3 text-sm leading-6 text-slate-400">{item.body}</p></article>)}</div>
        </Container>
      </section>
